...
public class MailReadWhileActivating {
	...
	/*
	 * public static void main(String args[]) { MailReadWhileActivating mr = new
	 * MailReadWhileActivating(); String url = mr.FetchMails("imap.gmail.com",
	 * "qa.gaurav239@gmail.com", "result1029", "Welcome to MediaFerry!");
