...
public class EmailProofProofingTest {
    ...
    public void emailProofing() throws InterruptedException {
        ...
        activeProjectsSteps.emailProofFromProofingWindow(driver, softAssert, driverObj.getSignUpEmail(), projectName);
        activeProjectsSteps.proofingEmailProof(driver, driverObj.getSignUpEmail());
    }
